...
CSV_PATH = "A1_causal_demand_keep-imputed_demand-only_168_READY.csv"
TARGET = "y_demand_t_plus_1"
DROP = ["ts_utc", "is_train", "is_test", TARGET]

BASE_PARAMS_PATH = "A1_stage1_stable_choice.joblib"

OUT_CV_RESULTS = "A1_stage2_polish_cv_results.csv"
OUT_BEST_PARAMS = "BEST_PARAMS_DEMAND.joblib"
