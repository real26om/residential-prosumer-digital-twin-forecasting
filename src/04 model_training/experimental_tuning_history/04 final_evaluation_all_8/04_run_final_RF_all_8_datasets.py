...
for name, path, group in DATASETS:
    ...
    # Safety: ensure n_jobs and random_state are set
    params["n_jobs"] = -1
...
out.to_csv("rf_results_all_8_datasets_168_FINAL.csv", index=False)
print("\nSaved: rf_results_all_8_datasets_168_FINAL.csv")
